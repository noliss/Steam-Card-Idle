...
- **VirusTotal / SHA256** — появятся на странице [Releases](../../releases) для zip **v1.0.2** после публикации (локальный билд и артефакт CI дают разный хеш).
...
- **VirusTotal / SHA256** — will be on [Releases](../../releases) for the **v1.0.2** zip after publish (local build hash ≠ CI artifact hash).
